...
Mut_table <- fread("data/mc3.v0.2.8.PUBLIC.LAML_PATCH.maf.oncokb.txt")
...
write.table(Results, "table/allsamples_scin_allMutations_linear_model_results.txt", quote=F, sep="\t", row.names = F)