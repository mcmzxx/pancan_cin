...
Final_table=subset(Final_table,Final_table$`Genome doublings`==0)
...
write.table(Results, "table/gd0_scin_allMutations_linear_model_results.txt", quote=F, sep="\t", row.names = F)