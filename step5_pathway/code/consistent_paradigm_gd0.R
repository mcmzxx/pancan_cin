...
fls1=list.files('table/paradigm_pathway_gd0',pattern = 'cor_paradigm_wgii_',full.names = T)
fls2=list.files('table/paradigm_pathway_gd0',pattern = 'cor_paradigm_scin_',full.names = T)
results=list()
df=NULL
for(fl in fls1){
  load(fl)
...
pheatmap::pheatmap(
  ...
  border_color = NA,
  main = 'consistent Pathway of wgii',
  show_rownames = T,
  show_colnames = T,
  treeheight_row = 0,
  fontsize = 3,
  ...
  cellheight = 3,
  treeheight_col = 0,
  file = "plot/consistent_pathway_of_wgii_gd0.pdf",
  width = 10.5,
  height = 28,
  color = rev(colorRampPalette(brewer.pal(11, "RdBu"))(2000))
)
...
pheatmap::pheatmap(
  ...
  clustering_distance_rows = "euclidean",
  border_color = NA,
  main = 'consistent Pathway of scin',
  show_rownames = T,
  show_colnames = T,
  treeheight_row = 0,
  fontsize = 3,
  ...
  cellheight = 3,
  treeheight_col = 0,
  file = "plot/consistent_pathway_of_scin_gd0.pdf",
  width = 10.5,
  height = 18,
  color = rev(colorRampPalette(brewer.pal(11, "RdBu"))(2000))
)