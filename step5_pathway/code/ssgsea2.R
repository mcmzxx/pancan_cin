...
save(gsva_biocart,file ='table/gsva_biocart_pathway5.RData')
save(gsva_react,file ='table/gsva_react_pathway5.RData')
save(gsva_kegg,file ='table/gsva_kegg_pathway5.RData')
save(gsva_cgp,file ='table/gsva_cgp_pathway5.RData')
save(gsva_hallmark,file ='table/gsva_hallmark_pathway5.RData')
save(gsva_oncokb,file ='table/gsva_oncokb_pathway5.RData')
save(gsva_ddr_v1,file ='table/gsva_ddrv1_pathway5.RData')
save(gsva_ddr_v2,file ='table/gsva_ddrv2_pathway5.RData')
save(gsva_go,file ='table/gsva_go_pathway5.RData')
