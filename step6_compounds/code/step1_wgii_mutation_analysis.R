...
#write.table(scores,file='/storage/zhang/experiments/DrugCell/data/raw/ccle/ccle_cin_scores.txt',sep='\t',quote = F,row.names = F,col.names = T)
...
write.table(Results, "table/wgii_allMutations_linear_model_results.txt", quote=F, sep="\t", row.names = F)